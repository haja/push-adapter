 ...
 * InstanceIDListenerService and implement {@link InstanceIDListenerService#onTokenRefresh()}.
 * <p/>
 * Include the following in the manifest:
 * <pre>
 * <service android:name=".YourInstanceIDListenerService" android:exported="false">
 *     <intent-filter>
 *         <action android:name="at.sbaresearch.microg.adapter.library.gms.iid.InstanceID"/>
 *     </intent-filter>
 * </service></pre>
