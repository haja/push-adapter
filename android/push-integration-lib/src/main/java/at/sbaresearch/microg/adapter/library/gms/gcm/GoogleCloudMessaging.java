 ...
 * registrationToken from {@link FirebaseInstanceID#getToken(java.lang.String, java.lang.String)}, which authorizes an
 * app server to send messages to an app instance. Pass sender ID and
 * {@link GoogleCloudMessaging#INSTANCE_ID_SCOPE} as parameters to the method.
...
public class GoogleCloudMessaging {
  /**
   * The GCM {@link GoogleCloudMessaging#register(java.lang.String...)} and {@link GoogleCloudMessaging#unregister()} methods are
   ...
   * {@link FirebaseInstanceID#getToken(java.lang.String, java.lang.String)}
   */
  public static final String INSTANCE_ID_SCOPE = GcmConstants.INSTANCE_ID_SCOPE_GCM;

  /**
   * Returned by {@link GoogleCloudMessaging#getMessageType(android.content.Intent)} to indicate that the server deleted
  ...
  public static final String TAG = "GoogleCloudMessaging";
   ...
   * {@link FirebaseInstanceID#getToken(java.lang.String, java.lang.String)}.
   * Set authorizedEntity to a sender ID and scope to {@link GoogleCloudMessaging#INSTANCE_ID_SCOPE}.
   */
  @Deprecated
  public String register(String... senderIds) throws IOException {
    ...
    Log.i(TAG, "register call with senderIds: " +
        Arrays.deepToString(senderIds));
    ...
    if (isLegacyFallback()) {
      ...
      return FirebaseInstanceID
          .getInstance(context).getToken(sb.toString(), INSTANCE_ID_SCOPE, extras);
    } else {
      Bundle extras = new Bundle();
   ...
   * IDs used when calling  {@link FirebaseInstanceID#getToken(java.lang.String, java.lang.String)}
  ...
  public void send(String to, String msgId, long timeToLive, Bundle data) throws IOException {
    ...
    if (isLegacyFallback()) {
      ...
      FirebaseInstanceID.getInstance(context).requestToken("GCM", "upstream", extras);
    } else {
   ...
   * {@link FirebaseInstanceID#deleteToken(java.lang.String, java.lang.String)} or
   * {@link FirebaseInstanceID#deleteInstanceID()}.
   */
  @Deprecated
  ...
  private String getFrom(String to) {
    ...
    return FirebaseInstanceID.getInstance(context).getStore().get("", to, INSTANCE_ID_SCOPE);
  }
}